console.log("--------------------Assignment-B)Array Of Objects-----------------------")
class Bank {
...
let axis_bank = new Bank("AXIS Bank", "Delhi", 123456, "AXIS0123", "12%");
let sbi_bank = new Bank("SBI Bank", "Mumbai", 456789, "SBI0456", "10%");
let icici_bank = new Bank("ICICI Bank", "Chennai", 112233, "ICICI0789", "8%");
let kotak_bank = new Bank("KOTAK Bank", "Ahamadabad", 445566, "KTK0789", "11%");
let hdfc_bank = new Bank("HDFC Bank", "Pune", 778899, "HDFC02112", "10.5%");
let punjab_bank = new Bank("PUNJAB Bank", "Chandigad", 010203, "PNB02134", "12.5%");
